 ...
 * @copyright    2008-2009 Intellispire, LLC./Nick Temple
 *
 */
...
class plgSystemCloudfront extends JPlugin {
  ...
  */
  function getAssets() {
    if (! $this->assets) {
      ...
      if (!$this->assets && $this->load(JPATH_ADMINISTRATOR . '/components/com_cloudfront/classes/cloudfront.class.php')) {        
        $cf = new CloudFront();
  ...
  */
  function collect($store = false) {
    if (! $this->load(JPATH_ADMINISTRATOR . '/components/com_cloudfront/classes/cloudfront.class.php')) {
      return false;
    }
  ...
  */
  function scan() {
    if (! $this->load(JPATH_ADMINISTRATOR . '/components/com_cloudfront/classes/cloudfrontjoomla.php')) {
      return false;
    }
